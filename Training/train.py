...
# Define constants
DATASET_PATH = './dataset/English.tar/English/data_x+'
# DATASET_VAL_PATH = './Data/MNISTData/'
MODEL_PATH = '.'
BATCH_SIZE = 128
EPOCHS = 50
# These need to be 28x28 for mnist dataset, but then size and strides need to be changed in model.py
# or resize image ?
# maybe resize them using windows ??
TARGET_WIDTH = 128
TARGET_HEIGHT = 128
TARGET_DEPTH = 3
